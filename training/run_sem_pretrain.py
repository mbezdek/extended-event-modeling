...
from utils import SegmentationVideo, get_binned_prediction, get_point_biserial, DictObj, \
    logger, parse_config, get_coverage, get_purity, event_label_to_interval
from preprocess_features.compute_pca_all_runs import PCATransformer
...
class SEMContext:
    ...
    def compute_clustering_metrics(self):
        ...
        df = pd.read_csv('../event_annotation_timing_average.csv')
