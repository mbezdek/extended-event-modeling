...
# CHPC paths:
vidpath="/scratch/mbezdek/rev_videos/"+run+"_C1_trim_rev.mp4"
csvin="/scratch/mbezdek/ground_truth_labels/"+run+"_C1_labels.csv"
csvout="/scratch/mbezdek/rev/"+run+"_C1_tracked_r.csv"
