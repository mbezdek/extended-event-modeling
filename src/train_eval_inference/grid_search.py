...
seeds = [x for x in range(1010, 1150, 10)]
# seeds = [x for x in [1020, 1030, 1080]]
node_id = 0
nodes = list(range(16, 33))
        ...
        for a in alfa:
            for l in lmda:
                for seed in seeds:
                    ...
                    #     continue
                    tag = f'april_13_{trigger}{threshold:.1E}_s{seed}_{a:.0E}_{l:.0E}'
                    # tag = f'feb_26_always_s{seed}_{a:.0E}_{l:.0E}'
