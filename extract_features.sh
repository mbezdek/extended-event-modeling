...
source activate tf
#rm intersect_features.txt sem_complete.txt sem_error.txt appear_complete.txt objhand_complete.txt skel_complete.txt vid_complete.txt results_appear_features.json results_objhand.json results_skel_features.json results_vid_features.json results_sem_run.json
